...
class HMLET_Front(nn.Module):
	def __init__(self, 
					config:dict, 
					dataset:BasicDataset):
		super(HMLET_Front, self).__init__()
		self.config = config
	...
	def computer(self, gum_temp, div_noise, hard):     
		...
		# Residual embeddings
		embs.append(all_emb_lin_3)
	
  	
		# layer 4
		all_emb_lin_4 = torch.sparse.mm(g_droped, all_emb_lin_3)

		# Residual embeddings
		embs.append(all_emb_lin_4)
